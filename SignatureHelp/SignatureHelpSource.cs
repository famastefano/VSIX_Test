...
namespace VSIX_Test.SignatureHelp
{
    // Holds the informations of a function parameter
    // Usually you don't create multiple
    ...
    internal class TestSignature : ISignature
    {
        ...
        // Calculates which signature we are working on depending on the number of commas we've typed
    ...
    internal class TestSignatureHelpSource : ISignatureHelpSource
    {
        ...
        // Determines which signatures will be part of the current SignatureHelpSession.
        // Here they are hardcoded, but in a real scenario you would get them from a language server.
        public void AugmentSignatureHelpSession(ISignatureHelpSession session, IList<ISignature> signatures)
        {
            ...
            ITrackingSpan applicableToSpan = m_textBuffer.CurrentSnapshot.CreateTrackingSpan(
             new Span(position, 0), SpanTrackingMode.EdgeInclusive, TrackingFidelityMode.Forward);
        ...
        // This method is used to decide whether the highest-priority Signature Help source can supply a matching signature.
        // If it can't, the method returns null and the next-highest-priority source is asked to supply a match.
        // Essentially, Chain of Command.
    ...
    internal sealed class TestSignatureHelpCommandHandler : IOleCommandTarget
    {
        ...
        {
#if DEBUG
            Microsoft.VisualStudio.Shell.ThreadHelper.ThrowIfNotOnUIThread(System.Reflection.MethodBase.GetCurrentMethod().ToString());
#endif
            ...
            if (pguidCmdGroup == VSConstants.VSStd2K && nCmdID == (uint)VSConstants.VSStd2KCmdID.TYPECHAR)
            {
                ...
                if (typedChar.Equals('('))
                {
                    ...
                    // CAREFUL, this throws an exception if there are no character before this one!
