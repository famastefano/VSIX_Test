...
namespace VSIX_Test.CodeCompletion
{
    internal class TestCompletionSource : ICompletionSource
    {
        ...
        // Here you should add completion sets depending on the current session.
    ...
    internal class TestCompletionHandlerProvider : IVsTextViewCreationListener
    {
        ...
        public void VsTextViewCreated(IVsTextView textViewAdapter)
        {
            ...
            Func<TestCompletionCommandHandler> createCommandHandler = () => { return new TestCompletionCommandHandler(textViewAdapter, textView, this); };
